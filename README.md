...
Поиск реализован в функции `findStreets(request)` в файле `src/index.js`.
...
Для оптимизации поиска, при уточнении запроса поиск осуществляется по уже найденым элементам.
